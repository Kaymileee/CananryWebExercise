...
const ItemFill = ({ item, setDe1, index, de1, next }) => {
  ...
  return (
    <div className="flex flex-col items-start p-10 mb-5 rounded-lg shadow ques">
      <h4 className="text-2xl font-semibold text-black">Ques {index + 1}:</h4>
