...
const DashBoard = () => {
  ...
  const handleCheck = () => {
    ...
    const result = compareArrays(demo, arr);
    if (result) {
      console.log("100/100");
    } else {
      console.log("50/100");
  ...
  return (
    <div className="container py-20">
      <div className="flex-col w-full h-[500px] bg-white rounded-lg px-20">
        ...
        {score && (
          <h3 className="my-10 text-xl font-medium text-blue-500">
            Score:{" "}
            <span className="text-xl font-medium text-blue-700">{score}</span>
          </h3>
        )}
        <button
