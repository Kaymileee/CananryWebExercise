    ...
    <div className="w-full p-20">
      <div className="h-screen text-black bg-white">
        ...
        <div className="flex flex-wrap items-center gap-x-2 gap-y-5 justify-evenly">
          <div className="h-[300px] bg-red-400 rounded-md w-[300px] relative cursor-pointer hover:opacity-70 transition-all z-10">
            <img
              src="https://lingokids.com/wp-content/uploads/2020/04/Face.png"
              alt=""
              className="object-cover w-full h-full"
            />
            <div className="absolute bottom-0 z-30 p-2 text-2xl font-bold text-white bg-black rounded-md left-2/4 -translate-x-2/4">
              Face Parts
            </div>
          </div>
