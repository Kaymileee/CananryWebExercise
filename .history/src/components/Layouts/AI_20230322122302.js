    ...
    <div className="container h-screen my-10 border rounded-lg bg-[#CCEDCB]">
      ...
      <div className="flex flex-col items-center justify-between">
        <div className="flex items-center justify-center gap-x-3">
          ...
          <label
            htmlFor="choose"
            className="w-full p-3 font-medium bg-white cursor-pointer"
          >
            Choose File
          </label>
          {imageURL && (
            <button
              className="p-3 text-white bg-black rounded-lg button"
              onClick={() => identify()}
            >
              Phân tích
            </button>
      ...
      <div className="flex items-start justify-center my-5 mainWrapper gap-x-2">
        <div className="mainContent">
          <div className="imageHolder w-[400px] h-[300px] overflow-hidden rounded-lg">
            {imageURL && (
              <img
                src={imageURL}
                alt="Upload Preview"
