...
const DashBoard = () => {
  ...
  return (
    <div className="container py-20">
      <div className="gap-x-5 bg-slate-500 p-[5px] rounded-md inline-flex justify-start">
        <div className="cursor-pointer tab-item active">Education</div>
        <div className="cursor-pointer tab-item ">Fashion</div>
        <div className="cursor-pointer tab-item ">Music</div>
      </div>
