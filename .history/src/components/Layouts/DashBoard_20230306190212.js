  ...
  return (
    <div className="container py-20">
      <div className="flex items-center my-5 gap-x-5">
        <Link
          to={"/multiple-choice"}
          className="p-4 text-white rounded-lg bg-slate-600 hover:bg-slate-200 hover:text-orange-600"
        >
          Trắc nghiệm
        </Link>
        <Link
      ...
      <div className="flex-col w-full h-[500px] bg-white rounded-lg p-20">
