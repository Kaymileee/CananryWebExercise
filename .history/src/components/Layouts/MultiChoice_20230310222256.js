    ...
    <DashBoard>
      <div className="container">
        <div className="p-10 bg-white rounded-lg">
          ...
          {/* Result */}
          <div className="bg-black w-[500px]  text-white">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Delectus
            debitis natus blanditiis incidunt id voluptates iusto maxime!
            Doloremque aliquid, nemo nisi, autem neque magnam ducimus
            voluptatibus adipisci at dignissimos porro?
          </div>
          {/* score */}
          {score >= 0 && (
          ...
          <div className="flex items-center justify-center gap-x-5">
            ...
            {score === 100 ? (
              <button className="px-6 py-3 my-10 rounded-lg bg-primary animate-pulse">
                Tiếp tục
              </button>
            ) : null}
          </div>
