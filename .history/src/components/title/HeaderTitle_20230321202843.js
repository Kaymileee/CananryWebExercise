    ...
    <>
      ...
      <div className="container my-10">
        ...
        <div className="flex items-center justify-between">
          <div
            className="border rounded-lg w-full h-[400px] bg-center bg-cover relative bg-opacity-70  rounded-lg"
            style={{
          ...
          >
            <div className="absolute inset-0 bg-black -z-0 bg-opacity-60"></div>
