    ...
    <>
      ...
      <div className="container my-10">
        ...
        <div className="grid grid-cols-3 gap-5">
          <div
            className="border  w-full h-[400px] bg-center bg-cover bg-no-repeat relative bg-opacity-70  rounded-lg"
            style={{
              backgroundImage: `url("https://img.freepik.com/free-photo/portrait-bearded-redhead-english-male_1157-39192.jpg?size=338&ext=jpg&uid=R40653510&ga=GA1.1.12167484.1678342596&semt=ais")`,
            }}
          >
            <div className="absolute inset-0 bg-black rounded-lg -z-0 bg-opacity-60"></div>
            <div className="absolute bottom-0 left-0 z-10 w-full p-5 text-left text-white">
              ...
              <div>
                <p>Owner of Canary</p>
                <a href="https://www.facebook.com/profile.php?id=100010598710045">
                  Contact me
                </a>
              </div>
            </div>
