...
const HeaderTitle = () => {
  ...
  return (
    <>
      <div className="flex  items-center justify-center py-20 bg-[#FBF2CF] container rounded-lg">
        <div>
          ...
          <Link
            className="inline-flex items-start justify-center gap-x-3 px-8 py-4 font-sans font-semibold tracking-wide text-white bg-gradient-secondary rounded-lg h-[60px] w-full sm:w-[230px] button-effect text-left"
            to={"/exercise"}
          >
            Let's Go
          </Link>
