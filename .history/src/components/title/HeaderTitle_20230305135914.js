  ...
  return (
    <div className="container">
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <button className="inline-flex items-center justify-center gap-x-3 px-8 py-4 font-sans font-semibold tracking-wide text-white  rounded-lg h-[60px] w-full sm:w-[230px] button-effect">
          Let's Go
        </button>
      </div>
    </div>
