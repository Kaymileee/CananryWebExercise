  ...
  return (
    <div className="container my-10">
      ...
      <div className="grid grid-cols-3 gap-x-5">
        <div className="relative overflow-hidden rounded-lg item">
          <img
            src="https://i.pinimg.com/236x/28/51/e7/2851e78de5e176558bdd5b677af2bd28.jpg"
            alt=""
            className="object-cover "
          />
          <div className="absolute bottom-0 left-0 bg-white">AI</div>
        </div>
      </div>
    </div>
  );
