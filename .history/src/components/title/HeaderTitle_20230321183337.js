...
const HeaderTitle = () => {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center py-20 bg-[#FBF2CF] container rounded-lg">
        <div>
        ...
        <img
          src="https://img.freepik.com/free-vector/diverse-group-children-kindergarten_74855-5811.jpg?w=996&t=st=1679398390~exp=1679398990~hmac=2c8a599b389885866733fa32f404976278f66208246b8f70c119c3f52b44657d"
          alt=""
        />
      </div>
